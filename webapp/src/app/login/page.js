...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white">
      <div className="relative hidden lg:flex flex-col justify-between bg-white p-12 text-gray-900 overflow-hidden border-r border-gray-100">
        <div className="relative z-20">
          <div className="flex items-center gap-2">
            <img src="/logou.png" alt="USPG" className="h-64 w-auto" />
          </div>
        </div>
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-gray-500">
          <span>Universidad San Pablo de Guatemala</span>
        </div>
